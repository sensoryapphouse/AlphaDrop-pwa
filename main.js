...
playGame.prototype = {
    preload: function () {
        ...
        game.load.image("crateb", "assets/sprites/crateb.png");
        game.load.image("cratec", "assets/sprites/cratec.png");
        game.load.image("crated", "assets/sprites/crated.png");
        game.load.image("cratee", "assets/sprites/cratee.png");

        game.load.image("cratel", "assets/sprites/cratel.png");
        game.load.image("cratelb", "assets/sprites/cratelb.png");
        game.load.image("cratelc", "assets/sprites/cratelc.png");
        game.load.image("crateld", "assets/sprites/crateld.png");
        game.load.image("cratele", "assets/sprites/cratele.png");
    ...
    create: function () {
        ...
        if (gameIndex == 0)
            this.movingCrate.loadTexture("crate");
        else if (gameIndex == 1 || gameIndex == 3)
            this.movingCrate.loadTexture("cratel");
        else
            this.movingCrate.loadTexture("crate1");
        ...
        crateTween.onLoop.add(looping, this);
    ...
    dropCrate: function () {
        ...
        if (this.canDrop && this.timer <= gameOptions.timeLimit) {
            ...
            switch (crateCount) {
                case 0:
                    if (gameIndex == 0)
                        fallingCrate.loadTexture("crate");
                    else if (gameIndex == 1 || gameIndex == 3)
                        fallingCrate.loadTexture("cratel");
                    else
                        fallingCrate.loadTexture("crate1");
                    break;
                case 1:
                    if (gameIndex == 0)
                        fallingCrate.loadTexture("crateb");
                    else if (gameIndex == 1 || gameIndex == 3)
                        fallingCrate.loadTexture("cratelb");
                    else
                        fallingCrate.loadTexture("crate2");
                    break;
                case 2:
                    if (gameIndex == 0)
                        fallingCrate.loadTexture("cratec");
                    else if (gameIndex == 1 || gameIndex == 3)
                        fallingCrate.loadTexture("cratelc");
                    else
                        fallingCrate.loadTexture("crate3");
                    break;
                case 3:
                    if (gameIndex == 0)
                        fallingCrate.loadTexture("crated");
                    else if (gameIndex == 1 || gameIndex == 3)
                        fallingCrate.loadTexture("crateld");
                    else
                        fallingCrate.loadTexture("crate4");
                    break;
                case 4:
                    if (gameIndex == 0)
                        fallingCrate.loadTexture("cratee");
                    else if (gameIndex == 1 || gameIndex == 3)
                        fallingCrate.loadTexture("cratele");
                    else
                        fallingCrate.loadTexture("crate5");
                    break;
            }
            crateCount++;
            if (crateCount > 4)
            ...
            switch (crateCount) {
                ...
                case 1:
                    if (gameIndex == 0)
                        this.movingCrate.loadTexture("crateb");
                    else if (gameIndex == 1 || gameIndex == 3)
                        this.movingCrate.loadTexture("cratelb");
                    else
                        this.movingCrate.loadTexture("crate2");
                    break;
                case 2:
                    if (gameIndex == 0)
                        this.movingCrate.loadTexture("cratec");
                    else if (gameIndex == 1 || gameIndex == 3)
                        this.movingCrate.loadTexture("cratelc");
                    else
                        this.movingCrate.loadTexture("crate3");
                    break;
                case 3:
                    if (gameIndex == 0)
                        this.movingCrate.loadTexture("crated");
                    else if (gameIndex == 1 || gameIndex == 3)
                        this.movingCrate.loadTexture("crateld");
                    else
                        this.movingCrate.loadTexture("crate4");
                    break;
                case 4:
                    if (gameIndex == 0)
                        this.movingCrate.loadTexture("cratee");
                    else if (gameIndex == 1 || gameIndex == 3)
                        this.movingCrate.loadTexture("cratele");
                    else
                        this.movingCrate.loadTexture("crate5");
                    break;
            }
            if (gameIndex < 2) {
